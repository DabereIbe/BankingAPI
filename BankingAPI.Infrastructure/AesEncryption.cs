...
namespace BankingAPI.Infrastructure
{
    ...
    {
        private static byte[] Key = Encoding.UTF8.GetBytes("mysmallkey1234551298765134567890");
        private static byte[] Iv = Encoding.UTF8.GetBytes("mysmallkey123456");
        ...
        /*public static T Decrypt<T>(byte[] encryptedText)
        {
            // Generate a random encryption key and initialization vector
            byte[] key = Key; // 256-bit key
            byte[] iv = Iv;   // 128-bit IV
